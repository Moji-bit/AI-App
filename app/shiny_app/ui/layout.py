    ...
    return ui.page_navbar(
        ...
        ui.nav_panel(
            ...
            ui.layout_columns(
                ui.card(
                    {"class": "card"},
                    ui.h4("Datendiagnostik"),
                    ui.output_text_verbatim("data_quality_status"),
                    output_widget("class_distribution_plot"),
                    output_widget("missing_plot"),
                ),
                ui.card(
                    {"class": "card"},
                    output_widget("correlation_plot"),
                    output_widget("feature_distribution_plot"),
                    output_widget("event_timeline_plot"),
                ),
                col_widths=[4, 8],
            ),
        ),
        ui.nav_panel(
            ...
            ui.layout_columns(
                ui.card(
                    ...
                    ui.input_action_button("suggest_preset", "Preset automatisch erkennen"),
                    ui.output_text_verbatim("preset_reason"),
        ...
        ui.nav_panel(
            ...
            ui.layout_columns(
                ui.card(
                    ...
                    ui.hr(),
                    ui.h5("Split-Quick-Presets"),
                    ui.div(
                        {"class": "quick-split"},
                        ui.input_action_button("split_701515", "70/15/15"),
                        ui.input_action_button("split_801010", "80/10/10"),
                        ui.input_action_button("split_602020", "60/20/20"),
                    ),
                    ui.input_slider("train_ratio", "Training %", 0.1, 0.9, 0.7, step=0.01),
                    ui.input_slider("val_ratio", "Validation %", 0.05, 0.4, 0.15, step=0.01),
                    ui.input_action_button("build_dataset", "Training Dataset bauen", class_="btn-primary"),
                ),
                ui.card(
                    {"class": "card"},
                    ui.output_text_verbatim("dataset_status"),
                    output_widget("split_distribution_plot"),
        ...
        ui.nav_panel(
            ...
            ui.layout_columns(
                ui.card(
                    ...
                    ui.input_numeric("momentum", "Momentum", 0.9, min=0.0, max=0.999, step=0.01),
                    ui.input_select("device", "Device", choices=["cpu", "cuda"]),
                    ui.output_text_verbatim("device_status"),
                ...
                ui.card(
                    {"class": "card"},
                    ui.output_text_verbatim("training_config_summary"),
                    output_widget("model_architecture_plot"),
        ...
        ui.nav_panel(
            ...
            ui.layout_columns(
                ui.card(
                    ...
                    ui.input_numeric("top_n", "Top-N Klassen", 3, min=1, max=10),
                ...
                ui.card(
                    ...
                    output_widget("prediction_timeline_plot"),
